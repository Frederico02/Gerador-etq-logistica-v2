...
root = tk.Tk()
root.geometry("400x400")  # aumenta a altura da janela para 400 pixels
root.title("Gerador de Etiquetas")

# Adiciona uma label antes da caixa de opções
label = tk.Label(root, text="Escolha um prefixo:")
label.pack()

options = ['05', '04', '03', '02', '01']
prefixo = tk.StringVar(root)
prefixo.set(options[0])  # Definir a primeira opção como padrão

# Cria uma caixa com as opções e associa a variável 'prefixo' a opção selecionada
option_menu = tk.OptionMenu(root, prefixo, *options)
option_menu.pack()
...
copyright = canvas.create_text(150, 150, text="© 2023 Frederico Almeida. Todos os direitos reservados.")
